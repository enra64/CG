...
public:
  ...
  struct Configuration
  {
    ...
    Vec2f reflectVelocityDampeningSpan;
    Vec2f forceParticleLifeSpan;
...
private:
  ...
  Vec3f sumParticleForces(size_t particleIndex);
  ...
  Vec3f mBasisU, mBasisV, mBasisW; //< Cached orthonormal system for velocity direction of spawned particles
