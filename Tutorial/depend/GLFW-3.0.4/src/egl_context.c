...
int _glfwCreateContext(_GLFWwindow *window,
    ...
    if (_glfw.egl.KHR_create_context) {
        ...
        if (strategy) setEGLattrib(EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY_KHR, strategy);
        ...
        if (wndconfig->clientAPI == GLFW_OPENGL_ES_API) setEGLattrib(EGL_CONTEXT_CLIENT_VERSION, wndconfig->glMajor);
